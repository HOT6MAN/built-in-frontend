            ...
            <div class="contents">
                ...
                <div class="jlNcEk">
                    <div class="sc-crHmcD fLCeMm">
                        ...
                        <div class="group">
                            <div class="input-wrapper">
                                <input name="displayName" disabled v-model="user.email" placeholder="이메일을 입력하세요" size="20">
                            </div>
                            <div class="width-maker">이메일을 입력하세요</div>
                        </div>
                    </div>
                </div>
